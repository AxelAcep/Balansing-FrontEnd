          ...
          children: [
            ...
            Container(
              ...
              children: [
                ...
                Text("Panduan untuk menggunakan fitur Cek Variasi Makanan.", style: GoogleFonts.poppins(color: const Color(0xFF64748B), fontSize: width*0.035, fontWeight: FontWeight.w400),),
                SizedBox(height: height*0.01,),
                SizedBox(
                  width: double.infinity,
            ...
            SizedBox(height: height*0.01),
             Container(
              ...
              children: [
                ...
                SizedBox(height: height*0.01,),
                Text("Cari tahu skor keberagaman pangannya si Kecil.", style: GoogleFonts.poppins(color: const Color(0xFF64748B), fontSize: width*0.035, fontWeight: FontWeight.w400),),
                SizedBox(height: height*0.01,),
                SizedBox(
                  width: double.infinity,
                        child: ElevatedButton(
