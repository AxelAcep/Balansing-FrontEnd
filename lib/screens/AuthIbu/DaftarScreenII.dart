...
import 'package:balansing/screens/AuthIbu/ConfirmDaftar.dart';
import 'package:balansing/models/ibu_model.dart'; // Ensure this path is correct
...
class _DaftarScreenStateII extends State<DaftarscreenII> {
  final TextEditingController _bundaController = TextEditingController();
  ...
  void initState() {
    super.initState();
    _bundaController.addListener(_updateButtonState);
    ...
    _noTelpController.addListener(_updateButtonState);
  ...
  void _updateButtonState() {
    setState(() {
      _buttonEnabled = _bundaController.text.isNotEmpty &&
          ...
          _rwController.text.isNotEmpty && _alamatController.text.isNotEmpty && _usiaController.text.isNotEmpty && _noTelpController.text.isNotEmpty; 
    });
  }
  ...
  Future<void> _performRegistration() async {
    ...
    final Ibu completeKaderData = Ibu(
      email: widget.initialEmail,
      password: widget.initialPassword,
      namaIbu: _bundaController.text,
    ...
    print("Nama Puskesmas: ${completeKaderData.namaIbu}");
    ...
    try {
      ...
      final String registrationMessage = await _authService.registerIbu(completeKaderData);
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: height * 0.01),
                                TextField(
                                  controller: _bundaController,
                                  onChanged: (_) => _updateButtonState(),
                                  decoration: InputDecoration(
                                    hintText: "Masukan nama bunda",
                               ...
                               TextField(
                                ...
                                TextField(
                                  ...
                                  onChanged: (_) => _updateButtonState(),
                                  decoration: InputDecoration(
                                    hintText: "Masukan Nama Jalan Rumah Anda",
                                    hintStyle: GoogleFonts.poppins(
                                      color: const Color(0xFF64748B),
                                    ),
                                    border: OutlineInputBorder(
